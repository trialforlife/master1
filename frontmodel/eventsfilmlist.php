...
if (mysql_affected_rows() > 0) {
	while($row = mysql_fetch_array($dbresult))
	{
		array_push($result["films"],array(
			...
			"filmpage"=>'<div style="float: left;width: 97%;padding-left: 1.5%; padding-right: 0.5%;"><span class="h2">'.$row["ev_name"]."</span><span class='time'>".$row["ev_time"]."</span><div class='f_con'><img style=\"width:200px; float:right ; margin-right:-1.5%; height:140px;\" src=http://now-yakutsk.stairwaysoft.net/mobile/img/".$row["ev_image"]."><pf>".$row["ev_content"]."</pf></div></div>",
