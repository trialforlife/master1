...
Ext.require([
    ...
    Ext.create("Ext.NestedList", {
        ...
        backText: '<img style=\"width:20px; float:left; margin-left:7px; margin-top:5px; height:40px;\" src=main-ico.png><div style=\"margin-left:29px; margin-top:6px;\">Главная</div>',
       // backButton: 'img/main-ico.png',
        ...
        listeners: { 
                    ...
                    leafitemtap: function(nestedList, list, index, target, record) {
                        ...
                        useTitleAsBackText: false,
                        defaultBackButtonText : null,
                        backText: '<img style=\"width:20px; float:left; margin-left:7px; margin-top:5px; height:40px;\" src=/main-ico.png><div style=\"margin-left:29px; margin-top:6px;\">Афиша</div>',
                        //useToolbar:false,
                        //leaf: true ,
                        iconCls: 'star',
                        displayField: 'title',
